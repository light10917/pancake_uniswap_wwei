...
export const CurrencyInputHeader = ({ title, subtitle }: Props) => {
  ...
  return (
    <AtomBox width="full" alignItems="center" flexDirection="column" padding="24px" paddingBottom="0px">
      <AtomBox display="flex" width="full" color="white" alignItems="center" justifyContent="space-between">
        {title}
      </AtomBox>
      {subtitle}
    </AtomBox>
